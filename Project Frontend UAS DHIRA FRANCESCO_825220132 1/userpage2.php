...
<div class="col-sm-9"><!--kolom kiri-->
  ...
  if (mysqli_num_rows($berita) > 0) {
    while ($row = mysqli_fetch_array($berita)) {
      ...
      // Mulai tampilkan data dari baris ke-5
      if ($count >= 5) {
  ?>
        <div class="d-flex">
  ...
  <ul class="pagination justify-content-center">
    <li class="page-item disabled">
      <a class="page-link" href="user.php" tabindex="-1" aria-disabled="true">Previous</a>
    </li>
    <li class="page-item"><a class="page-link" href="user.php">1</a></li>
    <li class="page-item"><a class="page-link" href="userpage2.php" style="color:red;">2</a></li>
  </ul>
</nav>
