...
<?php 
 ...
 if(isset($_POST['Edit']))
 {
  ...
  if(($ekstensifile == "jpg") or ($ekstensifile == "JPG"))
  {
   ...
   mysqli_query($connection, "update kendaraan set kendaraanNAMA='$namakendaraan', kendaraanJENIS='$jeniskendaraan', kendaraanMUATAN='$hargaMUATAN', 
   kendaraanFOTO='$namafile'
    where kendaraanKODE='$kodekendaraan'");
    header("location:kendaraan.php");
  }
 }

 $datadestinasi = mysqli_query($connection, "select * from kendaraan");
 //untuk menerima kiriman data dari data yang akan diubah
 $kodekendaraan = $_GET["ubah"];
 $editkendaraan = mysqli_query ($connection, "select * from kendaraan
  where kendaraanKODE = '$kodekendaraan'");
 $rowedit = mysqli_fetch_array($editkendaraan);
?>
    ...
    <div class="row">
      ...
      <div class="col-sm-10">
        <div class="jumbotron jumbotron-fluid">
          <div class="container">
            <h1 class="display-6">Edit Kendaraan</h1>
          </div>
        </div>
...
<div class="col-auto">
  <input type="text" id="kodekendaraan" class="form-control" aria-describedby="kodekendaraan" name="inputkode" value="<?php echo $rowedit ["kendaraanKODE"]?>" placeholder="Kode Kendaraan" readonly>
</div>
<div class="col-auto">
...
<br>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-4">
      <input type="text" class="form-control" id="namakendaraan" name="inputnama" value="<?php echo $rowedit ["kendaraanNAMA"]?>"placeholder="Nama kendaraan">
    </div>
  </div>
  <br>
