...
<?php 
 ...
 if(isset($_POST['Edit']))
 {
  ...
  $kendaraanKODE = $_POST['kodekendaraan'];
  ...
  if(($ekstensifile == "jpg") or ($ekstensifile == "JPG"))
  {
   ...
   mysqli_query($connection, "update travel set travelNAMA='$namatravel', travelTUJUAN='$tujuantravel',travelHARGA='$hargatravel', 
   travelFOTO='$namafile',travelRATING='$ratingtravel',kendaraanKODE='$kendaraanKODE'
 ...
 $datakendaraan = mysqli_query($connection, "select * from kendaraan");
 ...
 $editkendaraan = mysqli_query($connection, "select * from travel,kendaraan
              where travelKODE = '$kodetravel' and travel.kendaraanKODE = kendaraan.kendaraanKODE");
$rowedit2 = mysqli_fetch_array($editkendaraan);
...
<div class="jumbotron jumbotron-fluid">
            <h1 class="display-6">Edit Pusat travel-travel</h1>
     </div>
    <div class="row">
      ...
      <div class="col-sm-10">
        ...
        <input type="text" class="form-control" id="kodetravel" name="inputkode" placeholder="Input Kode Travel" value="<?php echo $rowedit ["travelKODE"]?>"readonly>
      </div> <br>
      <div class="col-md-6">
        <label for="inputnama" class="form-label">Nama Travel</label>
        <input type="text" class="form-control" id="inputnama" name="inputnama" placeholder="Input Nama Travel" value="<?php echo $rowedit ["travelNAMA"]?>">
      </div>
      </div>
      <br>
      <div class="col-sm-12">
    <div class="row">
        <div class="col-sm-3">
            <div class="form-floating">
                <select class="form-select" id="inputtujuan" name="inputtujuan" aria-label="Floating label select example">
                    <option selected>Tujuan yang terdaftar</option>
                ...
                <label for="inputtujuan">Pilih Tujuan Travel</label>
            </div>
        </div>
        <div class="col-sm-3">
        <div class="form-floating">
            <select class=" form-select" id="kodekendaraan" name="kodekendaraan" aria-label="Floating label select example">
            <option>Jenis Kendaraan </option>
            <?php while($row = mysqli_fetch_array($datakendaraan)) 
            {?>
            <option value="<?php echo $row["kendaraanKODE"]?>">
            <?php echo $row["kendaraanKODE"]?>
            <?php echo $row["kendaraanNAMA"]?>
            <a>kapasitas: </a><?php echo $row["kendaraanMUATAN"]?>
            </option>
            <?php } ?>
            </select>
            </div>
...
<div class="col-sm-3">
            <div class="form-floating">
                <select class="form-select" id="inputharga" name="inputharga" aria-label="Floating label select example">
                ...
                <label for="inputharga">Kisaran Harga Travel</label>
            </div>
        </div>
...
<div class="jumbotron jumbotron-fluid">
          <div class="container">
            <h1 class="display-6">Cari Travel</h1>
          </div>
        </div>
		<br>
</form>
...
?>
  ...
  <p class="card-text" style="color:gold;"><?php echo $row['travelRATING']; ?></p>
    ...
    <p class="card-text">Jenis: <?php echo $row['kendaraanKODE']; ?></p>
      ...
      <div class="col-sm-6">
          <a href="dasboardeditravel.php?ubah=<?php echo $row["travelKODE"]?>" class="btn btn-success btn-sm" title="Edit">
...
<div class="col-sm-1"></div>
  ...
  <script>
            ...
            {
                $('#kodekendaraan').select2(
                {
                    closeOnSelect: true,
                    allowcClear :true,
                    placeholder: 'Pilih kendaraan wisata'
                });
            });
        </script>
</body>
