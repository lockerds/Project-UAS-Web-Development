	...
	if(isset($_POST['Simpan']))
	{
     ...
     $hargatravel =$_POST['inputharga'];
		...
		if(($ekstensifile == "jpg") or ($ekstensifile == "JPG") or ($ekstensifile == "png") or ($ekstensifile == "PNG"))
		{
			...
			mysqli_query($connection, "insert into travel value ('$kodetravel', '$namatravel', '$tujuantravel', '$hargatravel','$namafile','$ratingtravel','$kendaraanKODE')");
		}
    ...
    <div class="row">
      ...
      <div class="col-sm-10">
        <div class="jumbotron jumbotron-fluid">
          <div class="container">
            <h1 class="display-6">Input travel</h1>
          </div>
        </div>
        ...
        <input type="text" class="form-control" id="kodetravel" name="inputkode" placeholder="Input Kode Travel">
      </div> <br>
      <div class="col-md-6">
        <label for="inputnama" class="form-label">Nama Travel</label>
        <input type="text" class="form-control" id="inputnama" name="inputnama" placeholder="Input Nama Travel">
      </div>
      </div>
      <br>
      <div class="col-sm-12">
