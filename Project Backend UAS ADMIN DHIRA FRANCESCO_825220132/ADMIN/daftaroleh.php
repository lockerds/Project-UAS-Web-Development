    ...
    <div class="row">
      ...
      <div class="col-sm-10">
        <div class="jumbotron jumbotron-fluid">
          <div class="container">
            <h1 class="display-6">Search Pusat Oleh-oleh</h1>
          </div>
        </div>
...
<?php
    ...
    }else {$query = mysqli_query($connection, "SELECT * FROM oleh2");
    }
        ...
        <div class="col-md-4 mb-4">
            <div class="card">
                <?php if (is_file("images/" . $row['olehFOTO'])) { ?>
                    <img src="images/<?php echo $row['olehFOTO'] ?>" class="card-img-top mx-auto p-2" alt="..." style="max-width: 500px; height: 250px;">
                <?php } else { ?>
                    <img src="images/noimage.png" class="card-img-top mx-auto p-2" alt="..." style="max-width: 400px;">
                <?php } ?>
                <div class="card-body">
                    <p class="card-text" style="color: gold;"><?php echo $row['olehRATING']; ?></p>
                    <h5 class="card-title"><?php echo $row['olehNAMA']; ?></h5>
                    <!-- Add more card text here as needed -->
