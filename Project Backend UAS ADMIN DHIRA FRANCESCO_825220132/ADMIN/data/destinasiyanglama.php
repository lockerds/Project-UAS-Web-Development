...
<?php
    ...
    if(isset($_POST['Simpan']))
    {
        ...
        header("location:destinasi-select.php");
...
<!-- penutup form search-->
        ...
        <table class="table table-hover table-dark">
            ...
            <tbody>
                ...
                < href="destinasiedit.php?ubah=<?php echo $row["destinasiKODE"]?>" class ="btn btn-success btn-sm" title=" edit">
                ...
                <a href="destinasiedit.php?ubah=<?php echo $row["destinasiKODE"]?>" class ="btn btn-danger btn-sm" title=" hapus">
